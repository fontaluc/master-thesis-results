...
plt.imsave('outputs/mnist.png', images[0], cmap='gray')
# 2x subsample for computational convenience
images = images.reshape((-1, 28, 28))[:, ::2, ::2]
plt.imsave('outputs/mnist_sub.png', images[0], cmap='gray')
...
plt.imsave('outputs/cmnist1.png', image1.to(torch.uint8).numpy())
...
plt.imsave('outputs/cmnist2.png', image2.to(torch.uint8).numpy())